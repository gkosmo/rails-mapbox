...
class MushroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mushroom" do
    assert_difference('Mushroom.count') do
      post mushrooms_url, params: { mushroom: { address: @mushroom.address, name: @mushroom.name } }
    end
  ...
  test "should update mushroom" do
    patch mushroom_url(@mushroom), params: { mushroom: { address: @mushroom.address, name: @mushroom.name } }
